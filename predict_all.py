...
if __name__ == "__main__":
    ...
    if platform.system() == "Darwin":
        ...
        INPUT_PATH = "/Volumes/shunyao-h1/训练数据/北京比赛/模拟摆拍试卷"
        # INPUT_PATH = "/Volumes/shunyao-h1/训练数据/北京比赛/北京设备全标注0621"
        # INPUT_PATH = "/Volumes/shunyao-h1/训练数据/北京比赛/性能测试"
        INPUT_PATH = "/Volumes/shunyao-h1/测试数据/北京田间第1批/辛集市全标注5-6"

    else:
        INPUT_PATH = "/data/data-test/北京设备全标注"
        INPUT_PATH = "/data/data-test/照片圆盘"
        INPUT_PATH = "/data/data-test/性能测试"
    # 摆拍
    OUTPUT_DIR = INPUT_PATH + "-3.13.4.m768-3.8.11"
    # 生产
    OUTPUT_DIR = INPUT_PATH + "-3.13.4-3.10.2"
    # OUTPUT_DIR = INPUT_PATH + "-3.13.4-3.10.2.t1"
    ...
    DRAW_BBOX = True
    DRAW_POLYGON = True
    # 未在 alg 配置 draw_filter 的根模型不绘 filtered；ENABLE_VALIDATION 时仍绘制 TOP1+TOP2 关注类相关校验框
    ...
    SAVE_IMAGE_SCALE: float | None = 0.25
    ...
    # 关闭时不做 mask_rate（polygon/外接框填充率）过滤，忽略 insect_alg_all.json 各类 out.mask_rate
